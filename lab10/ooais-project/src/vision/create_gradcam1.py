...
IMAGE_PATH = Path("data/processed/images/test/residential/residential_0000.jpg")
OUTPUT_PATH = Path("reports/gradcam_example.png")
OUTPUT_PATH = Path("reports/gradcam_forest.png")
OUTPUT_PATH = Path("reports/gradcam_residential.png")
